#### AstroITICueFR1.m ####
    1. Place the script in a directory containing your TDT data folder (or multiple data folders)
    2. Ensure the TDT MATLAB SDK is installed at one of the following locations on your machine:     'C:\TDT\TDTMatlabSDK', '/usr/local/tdt/TDTMatlabSDK', '~/Documents/TDT/TDTMatlabSDK',  '/Applications/TDT/TDTMatlabSDK', 'C:\Program Files\TDT\TDTMatlabSDK' 
    3. Open and run AstroITICueFR1.m in Matlab
...
#### Helper functions ####
    ...
    # print_data_keys.py
        Prints the known epoch components of a dataset
        - Set the path of the dataset you desire to analyze as the 'path' variable on line 3
        - Run from terminal with 'python3 print_data_keys.py' 